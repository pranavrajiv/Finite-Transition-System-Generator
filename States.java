...
public class States extends JFrame  
{
	...
	public static void writing(List<List<Props>> x)
	{
		try
		{
			...
			PrintWriter write = new PrintWriter("/Users/pranav/Desktop/"+fileName+".dot", "UTF-8");
			write.println("digraph ");
			write.println("{");
			write.println("\tedge [style=\"solid\"];");
	...
	public static void main(String[] args)
	{
		...
		Pattern p = Pattern.compile("\\{\"go_to\".*}],");
